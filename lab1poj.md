### Zadania laboratoryjne - powtórka z programowania strukturalnego + obsługa Git

Termin realizacji (hard-deadline) - 20.03.2021  23:59
...
**Zadanie 14**
Dowolne zadanie skompiluj i uruchom przy pomocy narzędzi javac oraz java. Do repozytorium dodaj przykład wywoałania.

**Zadanie 15** 
Wrzuć zadania do zdalnego repozytorium. Do rozwiązania dodaj zrzut ekranu z wynikiem. Link do repozytorium prześnij emailem do prowadzącego
pczapiewski@pjwstk.edu.pl. Tytuł emaila: POJ - Imię nazwisko - Nr Indeksu.